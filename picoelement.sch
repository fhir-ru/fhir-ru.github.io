...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>EvidenceVariable.jurisdiction</sch:title>
    <sch:rule context="f:EvidenceVariable/f:jurisdiction">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>EvidenceVariable.topic</sch:title>
    <sch:rule context="f:EvidenceVariable/f:topic">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>EvidenceVariable.type</sch:title>
    <sch:rule context="f:EvidenceVariable/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>EvidenceVariable.characteristic.definition[x] 1</sch:title>
    <sch:rule context="f:EvidenceVariable/f:characteristic/f:definition[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>EvidenceVariable.characteristic.usageContext</sch:title>
    <sch:rule context="f:EvidenceVariable/f:characteristic/f:usageContext">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>EvidenceVariable.characteristic.participantEffective[x] 1</sch:title>
    <sch:rule context="f:EvidenceVariable/f:characteristic/f:participantEffective[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>EvidenceVariable.characteristic.timeFromStart</sch:title>
